 ...
 * @generated
 */
public class Usability_rulesSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case Usability_rulesPackage.NAMED_ELEMENT: {
				NamedElement namedElement = (NamedElement)theEObject;
				T result = caseNamedElement(namedElement);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Usability_rulesPackage.CATALOGUE: {
			...
			case Usability_rulesPackage.RULE: {
			...
			case Usability_rulesPackage.EOL_CODE: {
				EOLCode eolCode = (EOLCode)theEObject;
				T result = caseEOLCode(eolCode);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Usability_rulesPackage.DESCRIPTION: {
				Description description = (Description)theEObject;
				T result = caseDescription(description);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Usability_rulesPackage.RANGE: {
				Range range = (Range)theEObject;
				T result = caseRange(range);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Usability_rulesPackage.DOUBLE_RANGE: {
			...
			case Usability_rulesPackage.BOOLEAN_RANGE: {
				BooleanRange booleanRange = (BooleanRange)theEObject;
				T result = caseBooleanRange(booleanRange);
				if (result == null) result = caseRange(booleanRange);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Usability_rulesPackage.STRING_RANGE: {
				StringRange stringRange = (StringRange)theEObject;
				T result = caseStringRange(stringRange);
				if (result == null) result = caseRange(stringRange);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case Usability_rulesPackage.INTEGER_RANGE: {
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>EOL Code</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>EOL Code</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseEOLCode(EOLCode object) {
		return null;
	}
